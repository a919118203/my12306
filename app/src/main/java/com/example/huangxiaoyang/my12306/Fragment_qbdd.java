...
public class Fragment_qbdd extends Fragment {
    private ListView lv;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.activity_qbdd,null);
        lv=view.findViewById(R.id.qbdd_lv);
                ...
                try {
                    ...
                    if(responseCode==HttpURLConnection.HTTP_OK){
                        ...
                        for(int i=0;i<zxinxi.length();i++){
                            ...
                            map.put("zfqk",xinxi.getString("status"));
                            ...
                            if(train.has("fromStationName"))
                                ...
                                if(train.has("startStationName"))s=train.getString("startStationName");
                                if(train.has("endStationName"))e=train.getString("endStationName");
                                map.put("city",s+"->"+e+" "+xinxi.getString("status")+"人");
                            }
